...
For RegTAP 1.1, these vocabulary resources are relevant because the
...
The rows for \rtent{time\_start} and \rtent{time\_end} in  
...
The rows for \rtent{spectral\_start} and \rtent{spectral\_end} in  
...
\rtent{intf\_type} to \verb|vs:ParamHTTP|.  An investigation on 2019-09-01 showed that the
