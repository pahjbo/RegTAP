...
\item[RegTAP-STC]This specification will be complemented by a schema of four tables, also
under the \rtent{rr} schema making up the relational registry, that gives coverages of resources on the spatial,
...
\includegraphics[width=\textwidth]{schema.pdffig}
...
\scriptsize\ttfamily xpath:/curation/&
...
\textbf{Datatype suggested}&
\textbf{Pertinent Fields}\\
Utype(s)\\UCD(s)\\Units\\xpaths&\texttt{VARCHAR(128)}&
res\_schema.schema\_utype\hfil\break
          ...
          intf\_param.ucd\hfil\break
          intf\_param.unit\hfil\break
          intf\_param.utype\hfil\break
...
\textbf{Datatype suggested}&
\textbf{Pertinent Fields}\\
predefined\\values&\texttt{VARCHAR(255)}&resource.content\_level\hfil\break
          resource.content\_type
        \\
\texttt{VARCHAR(64)}&
          resource.rights\hfil\break
          resource.waveband\\
\texttt{VARCHAR(32)}&resource.res\_type\hfil\break
...
\texttt{VARCHAR(4)}&interface.query\_type\hfil\break
          interface.url\_use\\
\end{tabular}
\vspace{5pt}
...
(7801)\hfil\break
          ...
          capability.cap\_description (100)\hfil\break
          \\
\texttt{VARCHAR(255)}&resource.res\_title\hfil\break
        ...
        \\
\texttt{VARCHAR(128)}&resource.version\hfil\break
          resource.source\_value\hfil\break
          res\_subject.res\_subject\hfil\break
          \\
\texttt{VARCHAR(64)}&res\_table.table\_name\hfil\break
          table\_column.name\hfil\break
          intf\_param.name
        \\
\texttt{VARCHAR(32)}&resource.source\_format\hfil\break
        ...
        \\
\texttt{VARCHAR(16)}&resource.short\_name\hfil\break
