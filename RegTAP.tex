...
\previousversion[http://www.ivoa.net/documents/RegTAP/20141030]{PR-20141030}
...
\citep{std:RI1}\todo{Update when RI1.1 (and TAPRegExt 1.1?) is REC}.
...
Astronomy Thesaurus UAT.  \todo{MD researches how they deprecate, also:
cite it properly}
Services SHOULD translate deprecated UAT terms encountered in
\vorent{content/subject} to their preferred forms according to the latest
...
and \vorent{rightsURI} values through \rtent{rr.res\_details} (see
...
\vorent{/accessURL} in
\ref{table_res_detail}.\todo{Perhaps update the discussion of
VODataService types for what we think will happen in VODS 1.2?}
...
\baselineskip=9ptivoid\hfil\break
...
\baselineskip=9ptshort\_name\hfil\break
...
\baselineskip=9ptres\_title\hfil\break
\makebox[0pt][l]{\scriptsize\ttfamily xpath:title}&
\footnotesize string&
The full name given to the resource.\\

\baselineskip=9ptupdated\hfil\break
...
\baselineskip=9ptcontent\_level\hfil\break
...
\baselineskip=9ptres\_description\hfil\break
\makebox[0pt][l]{\scriptsize\ttfamily xpath:content/description}&
\footnotesize string&
An account of the nature of the resource.\\

\baselineskip=9ptreference\_url\hfil\break
...
\baselineskip=9ptcreator\_seq\hfil\break
...
\baselineskip=9ptcontent\_type\hfil\break
...
\baselineskip=9ptsource\_format\hfil\break
...
\baselineskip=9ptsource\_value\hfil\break
...
\baselineskip=9ptres\_version\hfil\break
...
\baselineskip=9ptregion\_of\_regard\hfil\break
...
\baselineskip=9ptwaveband\hfil\break
...
\baselineskip=9ptres\_subject\hfil\break
...
\baselineskip=9ptstandard\_id\hfil\break
...
\baselineskip=9pttable\_description\hfil\break
\makebox[0pt][l]{\scriptsize\ttfamily xpath:description}&
\footnotesize string&
A free-text description of the table's contents.\\

\baselineskip=9pttable\_name\hfil\break
\makebox[0pt][l]{\scriptsize\ttfamily xpath:name}&
\footnotesize string&
...
\baselineskip=9pttable\_index\hfil\break
\makebox[0pt][l]{\scriptsize\ttfamily }&
\footnotesize integer&
An arbitrary identifier for the tables belonging to a resource.\\

\baselineskip=9pttable\_title\hfil\break
\makebox[0pt][l]{\scriptsize\ttfamily xpath:title}&
\footnotesize string&
A descriptive, human-interpretable name for the table.\\

\baselineskip=9pttable\_type\hfil\break
...
\baselineskip=9pttable\_utype\hfil\break
\makebox[0pt][l]{\scriptsize\ttfamily xpath:utype}&
\footnotesize string&
...
\baselineskip=9ptname\hfil\break
\makebox[0pt][l]{\scriptsize\ttfamily xpath:name}&
\footnotesize string&
The name of the column.\\

\baselineskip=9ptucd\hfil\break
...
\baselineskip=9ptdelim\hfil\break
...
\baselineskip=9pttype\_system\hfil\break
...
\baselineskip=9ptflag\hfil\break
...
\baselineskip=9ptcolumn\_description\hfil\break
\makebox[0pt][l]{\scriptsize\ttfamily xpath:description}&
\footnotesize string&
...
\baselineskip=9ptintf\_index\hfil\break
\makebox[0pt][l]{\scriptsize\ttfamily }&
\footnotesize integer&
An arbitrary identifier for the interfaces of a resource.\\

\baselineskip=9ptintf\_type\hfil\break
\makebox[0pt][l]{\scriptsize\ttfamily xpath:@xsi:type}&
\footnotesize string&
The type of the interface (vr:webbrowser, vs:paramhttp, etc).\\

\baselineskip=9ptintf\_role\hfil\break
...
\baselineskip=9ptstd\_version\hfil\break
...
\baselineskip=9ptquery\_type\hfil\break
...
\baselineskip=9pturl\_use\hfil\break
...
\baselineskip=9ptparam\_use\hfil\break
...
\baselineskip=9ptparam\_description\hfil\break
\makebox[0pt][l]{\scriptsize\ttfamily xpath:description}&
\footnotesize string&
...
\baselineskip=9ptrelationship\_type\hfil\break
...
\baselineskip=9ptvalidated\_by\hfil\break
...
\baselineskip=9ptval\_level\hfil\break
...
\baselineskip=9ptdate\_value\hfil\break
\makebox[0pt][l]{\scriptsize\ttfamily xpath:date}&
\footnotesize character[19]\hfil\break+timestamp&
A date associated with an event in the life cycle of the resource.\\

\baselineskip=9ptvalue\_role\hfil\break
...
The content of incoming \vorent{date/@type} 
...
\baselineskip=9ptdetail\_xpath\hfil\break
\makebox[0pt][l]{\scriptsize\ttfamily }&
\footnotesize string&
The xpath of the data item.\\

\baselineskip=9ptdetail\_value\hfil\break
\makebox[0pt][l]{\scriptsize\ttfamily }&
\footnotesize string&
...
\baselineskip=9ptalt\_identifier\hfil\break
\makebox[0pt][l]{\scriptsize\ttfamily }&
\footnotesize string&
...
\todo{discuss this in the context of the DDC note}
...
\todo{Does anyone object to removing this?  Speak up now or we'll remove
it before REC-1.1 (Marco has volunteered to update it, though)}
...
\item  Changed WD requirement to keep all \vorent{rights} and
\vorent{rightsURI} in \rtent{res\_detail}; doing this is optional now,
