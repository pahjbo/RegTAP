...
\previousversion[http://ivoa.net/documents/RegTAP/20190503]{PR-20190503}
...
domains, we try to give typographic hits as to the nature of entities
discussed:
...
given in the table descriptions are discussed are formed as discussed
...
\item Adding a column \rtent{authenticated\_only} in \rtent{interface}
...
\item Replaced inline XSLT utype maker with a link to an external resource.
\end{itemize}
