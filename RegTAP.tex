...
yields 15 tables.  For each table, \tapent{TAP\_SCHEMA} metadata is given together
...
service; the recommended discovery pattern for RegTAP might thus be 
updated in RegTAP 1.3.}.
...
In \tapent{TAP\_SCHEMA}, this schema MUST be associated with a
\tapent{utype} matching the data model identifier given in
sect.~\ref{registration}, i.e.,
